...
import 'package:book_app/features/home/presentation/view/widgets/Book_view_body.dart';
...
class _BookViewState extends State<BookView> {
  @override
  void initState() {
    BlocProvider.of<SimulatBookCubit>(context)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BookViewBody(books: widget.books),
    );
  }
}
